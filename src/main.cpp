...
unsigned int nStakeMinAge = 60 * 60 *1; // 8 hours
...
const string strMessageMagic = "Cleverbot Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    int64_t nSubsidy = 0.2 * COIN;
        ...
        {
            nSubsidy = 5900000 * COIN; // Pre-mine 40k COIN in first block
        } else {
            nSubsidy = 0.2;
        }
...
static const int64_t nTargetTimespan = 13 * 60 * 60;  // 13 hr
...
{
    RenameThread("cleverbot-loadblk");
